...
using BlazorFocused.Testing.Logging.Test.Extensions;
using Microsoft.Extensions.Logging;
using Xunit.Abstractions;

namespace BlazorFocused.Testing.Logging.Test.Logger;
...
public class TestLoggerTests
{
    ...
    public TestLoggerTests(ITestOutputHelper testOutputHelper)
    {
        ...
        testLogger = TestLoggerBuilder.CreateTestLogger<TestServiceWithLogger>(logAction);
