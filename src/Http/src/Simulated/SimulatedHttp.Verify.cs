...
{
    public void VerifyWasCalled(HttpMethod method, string url = default, object content = default)
    {
    ...
    private string CheckAny() => requests.Count == 0 ? "Generic (Any) Request" : string.Empty;
}
